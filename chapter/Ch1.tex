...
定义$\mathcal{L}$当中的\textbf{项}(term)如下：
...
（1）如果$x$位于某个量词的辖域之中，
且是该量词的指导变元，
则称$x$在公式$A$当中\textbf{约束出现}；

（2）否则，称$x$在公式$A$中\textbf{自由出现}。
\label{自由出现与约束出现的定义}
\end{definition}
